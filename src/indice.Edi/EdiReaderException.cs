...
public class EdiReaderException : EdiException
{
    ...
    internal static EdiReaderException Create(EdiReader reader, string message) => Create(reader, message, null);

    internal static EdiReaderException Create(EdiReader reader, string message, Exception ex) => Create(reader as IEdiLineInfo, reader.Path, message, ex);
