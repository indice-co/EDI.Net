...
public struct EdiPath : IComparable<EdiPath>, IEquatable<EdiPath>
{
    ...
    /// </summary>
    /// <returns></returns>
    public override int GetHashCode() => _SegmentPart.GetHashCode() ^ _ElementPart.GetHashCode() ^ _ComponentPart.GetHashCode();
    ...
    /// <returns></returns>
    public bool Equals(EdiPath other) => Segment.Equals(other.Segment) && Element.Equals(other.Element) && Component.Equals(other.Component);
